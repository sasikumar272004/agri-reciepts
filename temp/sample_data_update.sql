...
('jd_user', 'JD User', (SELECT role_id FROM roles WHERE role_key = 'JD'), NULL, NOW()),
('supervisor_user', 'Supervisor User', (SELECT role_id FROM roles WHERE role_key = 'Supervisor'), 1, NOW()),
('deo_user', 'DEO User', (SELECT role_id FROM roles WHERE role_key = 'DEO'), 2, NOW());
